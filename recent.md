...
closer:  [JSLint](http://www.javascriptlint.com/) [Source
Forge](http://sourceforge.net/projects/javascriptlint/) integration with Vim.

JSLint allows me to write all my Javascript in vim and when I save a file, it
